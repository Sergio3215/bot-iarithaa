...
function sendMessage() {
    ...
    if (guild && guild.channels.cache.get(channelDailyMsg)) {
        ...
        if (date.getHours() == 11 && date.getMinutes() == 0) {
            ...
            𝓗𝓸𝓵𝓪 @everyone 𝓮𝓼𝓹𝓮𝓻𝓸 𝓺𝓾𝓮 𝓱𝓪𝔂𝓪𝓷 𝓭𝓮𝓼𝓹𝓮𝓻𝓽𝓪𝓭𝓸 𝓬𝓸𝓷 𝓶𝓾𝓬𝓱𝓪 𝓮𝓷𝓮𝓻𝓰𝓲𝓪 𝔂 𝓺𝓾𝓮 𝓽𝓮𝓷𝓰𝓪𝓷 𝓾𝓷 𝓫𝓸𝓷𝓲𝓽𝓸 𝔂 𝓱𝓮𝓻𝓶𝓸𝓼𝓸 𝓭𝓲𝓪!`);

        }
        else if (date.getHours() == 3 && date.getMinutes() == 0) {
            guild.channels.cache.get(channelDailyMsg).send(`
            𝓗𝓮𝔂 @everyone! 𝓨𝓪 𝓮𝓼 𝓱𝓸𝓻𝓪 𝓭𝓮 𝓶𝓲𝓶𝓲𝓻, 𝓮𝓼𝓹𝓮𝓻𝓸 𝓺𝓾𝓮 𝓵𝓪 𝓱𝓪𝔂𝓪𝓷 𝓹𝓪𝓼𝓪𝓭𝓸 𝓶𝓾𝔂 𝓫𝓲𝓮𝓷,𝓳𝓾𝓰𝓪𝓭𝓸. 𝓟𝓮𝓻𝓸, 𝔂𝓪 𝓮𝓼 𝓽𝓪𝓻𝓭𝓮, 𝓪𝓼𝓲 𝓺𝓾𝓮 𝓿𝓪𝔂𝓪𝓷 𝓪𝓬𝓸𝓼𝓽𝓪𝓻𝓼𝓮, 𝓹𝓪𝓻𝓪 𝓺𝓾𝓮 𝓶𝓪ñ𝓪𝓷𝓪 𝓭𝓮𝓼𝓹𝓲𝓮𝓻𝓽𝓮𝓷 𝓬𝓸𝓷 𝓽𝓸𝓭𝓸 𝓮𝓵 𝓴𝓲. 
            　﹢　˖    　✦      ¸ .　﹢　 ° 　¸.    ° ˖ ･ ·̩
...
client.on('messageCreate', async (msg) => {
    ...
    try {
        let admin = false, mod = false, helper = false;
        ...
        helper = await member.roles.cache.has(process.env.rolHelper)
        await ManagerRoles(client, msg, EmbedBuilder, Colors, admin, mod, helper);
    }
    catch (ex) {
